...
def handle_start(message):
    ...
    bot.send_message(
        message.chat.id,
        (
            "🤖 *Bienvenido al Bot de ya tu Samsung MHDDoS [Free Fire]!*\n\n"
            "📌 *Como usar:*\n"
            "```/free <TYPE> <IP/HOST:PORT> <THREADS> <MS>```\n\n"
            "💡 *Ejemplo:*\n"
            "```/free UDP 143.92.125.230:10013 3 120```\n\n"
    ...
    try:
        ...
        bot.reply_to(
            ...
            (
                ...
                f"*⚠️ Atención! Este bot fue creado por*mi"
            ),
            reply_markup=markup,
            parse_mode="Markdown",
        )
